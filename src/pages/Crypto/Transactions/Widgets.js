        ...
        <React.Fragment>
                    ...
                    <CardBody>
                        <div className="d-flex mb-3">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="badge bg-warning-subtle text-warning text-warning badge-border"> BTC</Link>
                                <Link to="#" className="badge bg-info-subtle text-info badge-border"> ETH</Link>
                                <Link to="#" className="badgebg-primary-subtle text-primary badge-border"> USD</Link>
            ...
            <Col xxl={3} md={6}>
                <Swiper
                    ...
                    <SwiperSlide>
                        <Card className="card-animate">
                            <div className="card-body bg-warning-subtle text-warning">
                                <div className="d-flex mb-3">
                                    <div className="flex-grow-1">
                                        <lord-icon
