  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (contact) => (
          <>
            {contact.row.original.tags.map((item, key) => (<span className="badgebg-primary-subtle text-primary me-1" key={key}>{item}</span>))}
          </>
        ),
      },
      {
                ...
                <CardBody className="text-center">
                  ...
                  <ul className="list-inline mb-0">
                    ...
                    <li className="list-inline-item avatar-xs">
                      <Link
                        to="#"
                        className="avatar-title bg-warning-subtle text-warning text-warning fs-15 rounded"
                      >
                    ...
                    <Table className="table table-borderless mb-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {(info.tags || ["Lead", "Partner"]).map((item, key) => (<span className="badgebg-primary-subtle text-primary me-1" key={key}>{item}</span>))}
                          </td>
                        </tr>
                        <tr>
                          <td className="fw-medium">
