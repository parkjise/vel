    ...
    () => [
      ...
      },
      {
        ...
        Cell: (cell) => {
          switch (cell.value) {
            case "Pending":
              return <span className="badge text-uppercase bg-warning-subtle text-warning text-warning"> {cell.value} </span>;
            case "Cancelled":
            ...
            case "Returns":
              return <span className="badge text-uppercasebg-primary-subtle text-primary"> {cell.value} </span>;
            case "Delivered":
